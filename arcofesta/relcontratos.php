...
<?php
    ...
    $busca = "SELECT contrato.Númerocontrato,funcionario.nome,cliente.nome,contrato.Dataevento,contrato.preco,contrato.Tipoevento,contrato.cep,contrato.numero,
